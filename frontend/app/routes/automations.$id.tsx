...
export default function AutomationDetail() {
  ...
  // Vault balances for withdrawal
  const {
    optimism: optimismVault,
    etherlink: etherlinkVault,
    totalBalance: totalVaultBalance,
    hasAnyBalance: hasVaultBalance,
              ...
              <div className="mt-6 pt-6 border-t border-neutral-700">
                ...
                {!hasVaultBalance ? (
                  <div className="text-center py-6">
                    <div className="text-neutral-400 mb-2">No funds available for withdrawal</div>
                    <div className="text-sm text-neutral-500">
                      Deposit USDC to automation contracts to see withdrawable balances here.
                    </div>
                  </div>
                ) : (
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-neutral-800 rounded-lg p-4">
                        <div className="flex items-center gap-2 mb-2">
                          <div className="w-3 h-3 bg-blue-500 rounded-full" />
                          <span className="text-sm text-neutral-400">Total Vault Balance</span>
                        </div>
                        <div className="text-xl font-semibold text-white">
                      ...
                      <div className="bg-neutral-800 rounded-lg p-4">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm text-neutral-400">Optimism</span>
                        </div>
                        <div className="text-lg font-medium text-white">
                          {formatCurrency(optimismVault.vaultBalance)}
                        </div>
                      </div>
                      ...
                      <div className="bg-neutral-800 rounded-lg p-4">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm text-neutral-400">Etherlink</span>
                        </div>
                        <div className="text-lg font-medium text-white">
                          {formatCurrency(etherlinkVault.vaultBalance)}
                        </div>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full bg-blue-600 hover:bg-blue-700 transition-colors text-white font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 cursor-pointer"
                    >
                      <ArrowDownLeft className="w-5 h-5" />
                      Withdraw USDC
                    </button>
                    ...
                    <div className="text-xs text-neutral-400 text-center">
                      Withdraw your USDC from automation contracts back to your wallet
                    </div>
                  </div>
                )}
              </div>
