...
import { Play, Circle, Clock, DollarSign, Zap, TrendingUp, AlertTriangle } from 'lucide-react';
...
export function RightSidebar({ onWithdraw, onDeposit }: RightSidebarProps) {
  const [activeTab, setActiveTab] = useState<'simulation' | 'balances'>('simulation');
